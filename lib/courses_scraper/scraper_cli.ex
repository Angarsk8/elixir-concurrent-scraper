defmodule CoursesScraper.CLI do
  ...
  defp parse_args(argv) do
    ...
    case parse do
      {[{:help, _value} | _options], _args, []}    ->
        :help
      {[all: true], [path_to_file_with_paths], []} ->
        {:all, path_to_file_with_paths}
      {_, [path_to_file_with_paths] , _}           ->
        {:all, path_to_file_with_paths}
      {[], [path_to_file_with_paths, items], []}   ->
        {safe_cast_to_int(items), path_to_file_with_paths}
      _                                            ->
        :help
    end
  end
